...
INSERT INTO member ( userid, userpw, username, userlocation, userage, usergender )
VALUES 
('test1', 'test1', '홍길동', 'test1', 25 , 'man'),
('test2', 'test2', '임꺽정', 'test2', 35 , 'man'),
('test3', 'test3', '심사임', 'test3', 45 , 'woman');
